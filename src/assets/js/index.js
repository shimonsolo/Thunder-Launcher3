...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "Se viene", "author": "shimonsoloMC" },
            { "message": "Esto esta potente", "author": "shimonsoloMC" },
            { "message": "Bienvenid@ al launcher", "author": "shimonsoloMC" }
        ];
    ...
    async checkUpdate() {
        ...
        ipcRenderer.invoke('update-app').then().catch(err => {
            return this.shutdown(`error al buscar la actualización:<br>${err.message}`);
        });

        ipcRenderer.on('updateAvailable', () => {
            this.setStatus(`¡Actualización a la vista!`);
    ...
    async maintenanceCheck() {
        config.GetConfig().then(res => {
            ...
            console.error(e);
            return this.shutdown("No se detectó ninguna conexión a Internet,<br>inténtelo de nuevo más tarde.");
        })
    }
